...
function queryuser()
{
	var qname = $('#qname').val();
	$('#userdg').datagrid({
		url:'/userquery.action?qname='+qname
	})
}
function saveroleuser()
{
	...
	$.ajax({
		url:'/roleassign.action?roleId='+roleid+"&userId="+userid,
...
function openuser(index, row)
{
	...
	var userId = row.id;
	$('#userroledg').datagrid({
		url:'/userrolequery.action?userId='+userId
	})
}
...
<body class="easyui-layout">
    ...
    <div data-options="region:'center',title:'用户查询'" style="padding:5px;">
		<table id="userdg" class="easyui-datagrid" style="width:100%;height:250px"   
		        data-options="url:'/userquery.action',fitColumns:true,pagination:true,
		...
		<div id="win" class="easyui-window" title="用户角色授权窗口" style="width:600px;height:320px"   
		    ...
		    <div class="easyui-layout" data-options="fit:true">  
				<table id="userroledg" class="easyui-datagrid" style="width:100%;height:250px"   
				        data-options="url:'/userrolequery.action',fitColumns:true,pagination:true,
